    ...
    */
    ...
    jQuery.extend(Unbxd.setSearch.prototype,{
        ...
        ,setEvents : function() {
            ...
            if (this.options.type == "search") {
                if ("form" in this.input && this.input.form) {
                    jQuery(this.input.form).bind("submit",function(e) {
                        ...
                        // If the search query is empty, set it to "*"
                        self.params.query = self.options.sanitizeQueryString.call(self, (self.input.value === "" ? "*" : self.input.value));
            ...
            if (this.options.isAutoScroll) {
                jQuery(window).scroll(function() {
                    ...
                    if ((wind.scrollTop()) > (docu.height() - wind.height() - self.options.heightDiffToTriggerNextPage)
                        && self.currentNumberOfProducts < self.totalNumberOfProducts
                        && !self.isLoading) {
                        self.setPage(self.getPage() + 1)
        ...
        ,paintProductPage : function(obj) {
            ...
            } else if (this.options.searchResultSetTemp !== null
                && typeof this.options.searchResultSetTemp === 'object') {
        ...
        ,paintViewTypes: function(obj) {
            ...
            var viewTypeOptions = this.options.viewTypes.map(function(opt) {
                return {
                    "value": opt,
                    "selected": (this.getViewType() == opt ? true : false)
                };
            }.bind(this));
        ...
        ,paintFacets: function(obj) {
            ...
            if (this.options.getFacetStats.length
                ...
                && "stats" in obj
                && obj.stats[this.options.getFacetStats] != null) {
        ...
        ,paintSelectedFacets : function() {
            ...
            if (selFacetKeysLength) {
                ...
                if (this.options.selectedFacetTemp
                    && this.options.selectedFacetContainerSelector) {
